...
extern int gf_spi_read_bytes(gf_dev_t *gf_dev, u16 addr, u32 data_len, u8 *rx_buf);
extern int gf_spi_write_bytes(gf_dev_t *gf_dev, u16 addr, u32 data_len, u8 *tx_buf);
