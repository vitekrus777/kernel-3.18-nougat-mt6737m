...
#if defined(BUILD_LK)
    printf("%s,aeon_jd9365_hd720_dsi_vdo_f509_xiaozhixing id_high = 0x%08x,id = 0x%08x\n", __func__, id_high,id);
#else
    printk("%s,aeon_jd9365_hd720_dsi_vdo_f509_xiaozhixing id_high = 0x%08x,id = 0x%08x\n", __func__, id_high,id);
#endif
...
LCM_DRIVER aeon_jd9365_hd720_dsi_vdo_f509_xiaozhixing_lcm_drv =
{
  .name			= "aeon_jd9365_hd720_dsi_vdo_f509_xiaozhixing",
